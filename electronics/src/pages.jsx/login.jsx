...
//     localStorage.setItem("erty", JSON.stringify(formdata))
//     setLogin(true)
...
// const saveddata = JSON.parse(localStorage.getItem("erty"))
...
//    const dataToStores = formdata ? formdata : [];
// localStorage.setItem("erty", JSON.stringify(dataToStores));
