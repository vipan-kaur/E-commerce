...
const Contact = () => {
  ...
  return (
    ...
    <div className='flex flex-col md:flex-row  min-h-screen justify-center items-center'>
        ...
        <input id='firstname' value={data.firstname} onChange={handleinput} name="firstname"  type="text" className='border-b p-2 outline-none hover:border-b-0 '></input>
        </div>
        ...
        <input id='email' value={data.email} type="email" onChange={handleinput} name="email" className='border-b p-2 outline-none hover:border-b-0'></input>
        </div>

        <div className='flex flex-col'>
        <label htmlFor='phone'>Phone*</label>
        <input id='phone' value={data.phone} name="phone" onChange={handleinput} className='border-b p-2 outline-none hover:border-b-0'></input>
        </div>
